...
import { INITIAL_OWNER_SUGGESTION } from "@/lib/initial-owner";
...
const passwordSchema = z
  ...
  .min(4, { message: "گذرواژه حداقل ۴ نویسه باشد." })
...
/**
 * Prefilled suggestion for the first owner. Fully editable — the OWNER role is
 * granted by the one-time initialization step to whoever completes this form,
 * not to this username.
 */
const emptyValues: OwnerFormValues = {
  fullName: INITIAL_OWNER_SUGGESTION.fullName,
  username: INITIAL_OWNER_SUGGESTION.username,
  password: INITIAL_OWNER_SUGGESTION.password,
  confirmPassword: INITIAL_OWNER_SUGGESTION.password,
};
