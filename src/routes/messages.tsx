                ...
                >
                  ...
                  >
                    <Avatar className="size-11">
                      {ch.avatarUrl ? <AvatarImage src={ch.avatarUrl} alt={ch.title} /> : null}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 shrink-0 space-y-2 border-t border-on-hero/10 bg-[oklch(0.16_0.02_52/0.55)] p-3 backdrop-blur-md">
        ...
        {emojiOpen ? (
          <EmojiPicker onPick={(emoji: string) => setText((t) => t + emoji)} />
        ) : null}
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <IconBtn label="ایموجی" onClick={() => setEmojiOpen((o) => !o)}>
