...
import { BIKE_TYPE_LABEL, isRepairedBike, useStore, type BicyclePurchase } from "@/lib/store";
...
function PurchasesPage() {
  ...
  const list = useMemo(() => {
    ...
    return state.purchases
      // Repaired bikes leave the purchases accounts entirely.
      .filter((p) => !isRepairedBike(p))
